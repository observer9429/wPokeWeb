        ...
        $elFigure.forEach(element => {
           ...
           // console.log(element.dataset.idactual);
            if(element.dataset.idactual===idPokemon){
                ...
                const $ataque=element.querySelector(".ataque");
                const $defensa=element.querySelector(".defensa");
...
////////////////// //hacemos visible el boton previo
                ...
                //agregando el ataque y defensa de la evolucion
...
/*
                if(sessionStorage.getItem("theUser")){
                    ...
                    console.log("entramos al sesion storage the user");
