...
export async function figWithAdd(losIds,losBooleanos) {

    console.log(jsonPoke);
    console.log(losIds);
    console.log(losBooleanos);

    /*
    const idsCapturados= getIds();
    console.log(idsCapturados);
*/
    ...
    for (let i = 0; i < losIds.length; i++) {//si queremos cambiamos el json poke por
        ...
        try {
           ...
           // $figure.dataset.name1
            ...
            /*
            let eltrue = idsCapturados.find(element =>{
                element===losIds[i];
                console.log(element);
                console.log(losIds[i]);
...
*/
            ...
            /*
            idsCapturados.find(element =>{ 
                if(element==losIds[i]){
                    console.log("el "+element+" y el "+losIds[i]);
